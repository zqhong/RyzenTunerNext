...
**电源状态检测**：`GetSystemPowerStatus()` Win32 API，AC 切换时通过 `RegisterPowerSettingNotification` 的 `GUID_ACDC_POWER_SOURCE` 事件即时响应。
